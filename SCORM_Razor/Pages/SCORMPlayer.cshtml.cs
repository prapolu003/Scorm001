...
namespace SCORM_Razor.Pages
{
    public class SCORMPlayerModel : PageModel
    {
        ...
        public SCORMPlayerModel(UserManager<IdentityUser> User, IConfiguration Configuration, IWebHostEnvironment hostingEnvironment, ILogger<SCORMPlayerModel> logger)
        {
            _userManager = User;
